    ...
    <div className="bg-white">
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-6">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-3 pt-15">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">Shop Today's Deal !</h1>
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
                        ...
                        <div className="mt-4 flex justify-between">
                          <div>
                            ...
                            <p className="mt-1 text-sm text-gray-500">
                              <StarIcon className='w-6 h-6 inline #facc15'></StarIcon><span className='align-bottom'>{product.rating}</span></p>
                            
                          </div>
                          <div>
                          <p className="text-sm font-medium block text-gray-900">₹{Math.round(product.price*(1-product.discountPercentage/100))}</p>
                             <p className="text-sm font-medium block line-through text-gray-400">₹{product.price}</p>
           ...
           {/* section of product and fliters ends here*/}
