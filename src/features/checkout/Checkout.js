...
export  default function Checkout() {
  ...
  return (
    ...
    <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
      {/* to give margin */}
       <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
        {/* to divide cart and info in coloums */}
    ...
    <div className="space-y-12">
      ...
      {addresses.map((address) => (
        <li key={address.name} className="flex justify-between gap-x-6 py-5 ">
          ...
          <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
            <p className="text-sm leading-6 text-gray-900">Phone Number: {address.phone}</p>
      ...
      <div className="mx-auto mt-12  max-w-7xl px-4 sm:px-0 lg:px-8">
    <div className="mx-auto bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
    
      <h2 className='text-2xl my-5 font-bold  bg-white tracking-tight text-gray-900'>Order Summary</h2>
    <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
    <div className="flow-root">
      <ul role="list" className="-my-6 divide-y divide-gray-200">
        {products.map((product) => (
          <li key={product.id} className="flex py-6">
            <div className="h-24 w-24 flex-shrink-0 overflow-hidden rounded-md border-solid border-gray-200">
              <img
            ...
            <div className="ml-4 flex flex-1 flex-col">
              ...
              <div className="flex flex-1 items-end justify-between text-sm">
                ...
                <label htmlFor="quantity" className="inline mr-5 text-sm font-medium leading-6 text-black">
               Qty
              </label>
                <select>
